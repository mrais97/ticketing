...
WHERE A.id>1 AND G.flag_input='1'
...
LEFT JOIN ticket_staging.mr_ksldiv H
ON G.ID_KSLDIV = H.ID_KSLDIV
WHERE A.id>1 AND I.user_uid='$uiduser' AND I.flag='1' AND G.flag_input='1'
ORDER BY A.created_at DESC";
}
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="material-datatables">
                                    <table id="ticket_manager" class="table table-striped table-no-bordered table-hover"
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#ticket_manager').DataTable({
            "bProcessing": true,
            "serverSide": true,
            "ajax": {
                url: "../ajax/ticket_manager.php",
                type: "POST",
                error: function () {
