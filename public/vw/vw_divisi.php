                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title" style="display: inline-block">Division List</h4>
                                <button class="btn btn-rose" data-toggle="modal"
                                        data-target="#addcat" style="float: right">Create Division
                                ...
                                <div class="material-datatables">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <thead>
                                        <tr>
                                            <th style="text-align: center;">ID Divisi</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center" class="td-actions text-right">
                                                <a class="btn btn-rose btn-fill" <?php echo "href='vw_edit_divisi.php?id=$row[0]'"; ?>>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal">
                                <div class="row">
                                    <div class="form-group row">
                                        ...
                                        <select class="col-md-3" data-style="select-with-transition" id="div">
                                            ...
                                            <?php
                                            $sql = mysqli_query($con, "SELECT ID_KSLDIV,KSLDIV FROM ticket_staging.mr_ksldiv");
                                            while ($row = $sql->fetch_assoc()){
                                                echo "<option value=".$row['ID_KSLDIV'].">".$row['KSLDIV']."</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group row">
                                        <label class="col-md-3 label-on-left">Email Divisi</label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="email" id="catname"><!--</input>-->
                                        </div>
                                    </div>
                                </div>
                                <!--                                <div class="row">-->
                            ...
                            <script>
                                $(document).ready(function () {
                                    $("#button").click(function () {
                                        ...
                                        if(catname && div && flag) {
                                            $.ajax({
                                                url: '../proses/pros_add_divisi.php',
