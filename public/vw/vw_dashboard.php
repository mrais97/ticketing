                                        ...
                                        <div class="tab-content">
                                                    ...
                                                    if ($roleuser == 3) {
                                                        ...
                                                        $sql2 = "SELECT
																 ...
																 FROM 
																	...
																	ON B.id = G.id_detail
																 WHERE 
																	A.id>1 AND G.user_uid='$uiduser' and G.flag='1'";
                                                    } else {
                                                        $sql2 = "SELECT
																	COUNT(flag) AS 'Total',
																	COUNT(CASE WHEN flag ='0' THEN 'Open' END)AS 'Open' ,
																	...
																	COUNT(CASE WHEN flag ='2' THEN 'Hold' END)AS 'Hold'
																 FROM 
																	t_transaksi WHERE id > 1 and pic_report = '$uiduser'";
                                                    }
                                            ...
                                            <div class="tab-pane" id="IT">
                                                <table class="table">
                                                    ...
                                                    LEFT JOIN t_category_detail b
                                                    ON a.id_detail=b.id
                                                    WHERE a.id > 1 AND a.id_divisi='59' AND b.id_category IN(1,2)";
                                                    } else if ($roleuser == 2) {
                                                        $sql3 = "SELECT
                                                    COUNT(A.flag) AS 'Total',
                                                    COUNT(CASE WHEN A.flag ='0' THEN 'Open' END)AS 'Open' ,
                                                    ...
                                                    LEFT JOIN ticket_staging.t_mapping_pic G
                                                    ON B.id = G.id_detail
                                                    WHERE A.id>1 AND A.id_divisi='59' AND G.user_uid='$uiduser' AND G.flag='1' AND B.id_category IN(1,2)";
                                                    ...
                                                    LEFT JOIN t_category_detail b
                                                    ON a.id_detail=b.id
                                                    WHERE a.id > 1 AND a.id_divisi='59' and a.pic_report = '$uiduser' AND b.id_category IN (1,2)";
                                                    }
