...
$sql = "SELECT * FROM t_divisi WHERE id='$id' ";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title" style="display: inline-block">Edit Division</h4>
                                <form class="form-horizontal" method="POST">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="form-group row">
                                                <input type="hidden" id="creator" name="creator" value="<?php echo $data['ID']; ?>">
                                                <label class="col-sm-3" style="text-align: right;">Division</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" type="text" id="catid" value="<?php echo $data['Nama_div']; ?>" disabled="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-md-3" style="text-align: right;">Email Divisi</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" type="text" id="catname" value="<?php echo $data['Email_div']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-md-3" style="text-align: right;">Divisi Status</label>
                                                <div class="col-md-9">
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            $("#button").click(function () {
                                                ...
                                                $.ajax({
                                                    url: '../proses/pros_edit_divisi.php',
                                                    method: 'POST',
                                                    data: {
                                                        catid:catid,
                                                        creator:creator,
                                                    ...
                                                    success: function (data) {
                                                        $(location).attr('href', 'vw_divisi.php');
                                                    }
                                                });
                                                }
                                                else{
