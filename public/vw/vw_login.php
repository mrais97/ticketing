                        ...
                        <form method="post">
                            <div class="card card-login card-hidden">
                                ...
                                <div class="footer text-center">
                                    <a onclick="sendData()" type="button" class="btn btn-rose btn-simple btn-wd btn-lg">
                                        <!--                                                href="--><?php //echo _BASE_DIR ?><!--vw/vw_dashboard.php"                                 >-->
                                        GO</a>
                                    ...
                                    <script>
                                        function sendData() {
                                            ...
                                            var pass = $("#pass").val();
                                            $.ajax({
                                                url: '<?php echo _BASE_DIR ?>/proses/pros_login.php',
                                                method: 'POST',
                                                data: {
                                                    username: username,
                                                    pass: pass
