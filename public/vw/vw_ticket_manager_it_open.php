...
WHERE A.id>1 AND G.flag_input='1' AND A.flag = '0' AND A.id_divisi='59' AND C.id IN (1,2)
...
LEFT JOIN ticket_staging.mr_ksldiv H
ON G.ID_KSLDIV = H.ID_KSLDIV
WHERE A.id>1 AND I.user_uid='$uiduser' AND I.flag='1' AND G.flag_input='1' AND A.flag = '0' AND A.id_divisi='59' AND C.id IN (1,2)
ORDER BY A.created_at DESC";
}
                                        ...
                                        <?php while ($row = mysqli_fetch_array($result)) {
                                            if ($row[8] == 'open') { ?>
                                                ...
                                                <tr style="font-weight: bold">
                                                    ...
                                                    <td align="center"
                                                        style="color: #e74c3c;font-weight: bold;"><?php echo $row[8]; ?></td>
                                                    <!--status-->
                                            ...
                                            <?php } else if ($row[8] == 'close') { ?>
                                                <tr style="opacity: 0.6;font-weight: bold">
                                                    ...
                                                    <td align="center"><?php echo $row[13]; ?>
                                                        <br><?php echo $row[12]; ?></td><!--prioritas-->
                                                    <td align="center"
                                                        style="color: #1abc9c;font-weight: bold;"><?php echo $row[8]; ?></td>
                                                    <!--status-->
                                                    <td align="center"><?php echo $row[9]; ?></td><!--PIC-->
                                                    <td align="center" class="more">
                                                        <?php echo $row[10]; ?><!--problem--></td>
                                            ...
                                            <?php } else { ?>
                                                <tr>
                                                    ...
                                                    <td align="center"><?php echo $row[13]; ?>
                                                        <br><?php echo $row[12]; ?></td><!--prioritas-->
                                                    <td align="center"
                                                        style="color: #f1c40f;font-weight: bold;"><?php echo $row[8]; ?></td>
                                                    <!--status-->
                                                    <td align="center"><?php echo $row[9]; ?></td><!--PIC-->
                                                    <td align="center" class="more">
                                                        <?php echo $row[10]; ?><!--problem--></td>
