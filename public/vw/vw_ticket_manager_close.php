...
WHERE A.id>1 AND G.flag_input='1' AND A.flag = '1'
...
LEFT JOIN ticket_staging.mr_ksldiv H
ON G.ID_KSLDIV = H.ID_KSLDIV
WHERE A.id>1 AND I.user_uid='$uiduser' AND I.flag='1' AND G.flag_input='1' AND A.flag = '1'
ORDER BY A.created_at DESC";
}
                                        ...
                                        <?php while ($row = mysqli_fetch_array($result)) {
                                            if ($row[8] == 'open') { ?>
                                                ...
                                                <tr style="font-weight: bold">
                                                    ...
                                                    <td align="center" class="more"><?php echo $row[7]; ?> </td>
                                                        <!--problem-->
