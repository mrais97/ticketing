...
$sql = "SELECT A.id,B.detail_category_name,C.nama ,A.flag,
        CASE 
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">PIC Manager</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title" style="display: inline-block">Edit PIC</h4>
                                <form class="form-horizontal" method="POST">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-sm-3" style="text-align: right;">PIC ID</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" type="text" id="picid"
                                        ...
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-sm-3" style="text-align: right;">PIC Name</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" type="text" id="picname"
                                        ...
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-md-3" style="text-align: right;">Category
                                                    Detail</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" type="text" id="catdet"
                                        ...
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-md-3" style="text-align: right;">PIC Status</label>
                                                <div class="col-md-9">
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            $("#button").click(function () {
                                                ...
                                                var flag = $("#flag").val();
                                                $.ajax({
                                                    url: '../proses/pros_edit_mapping.php',
                                                    method: 'POST',
                                                    data: {
                                                        picid: picid,
                                                        flag: flag
                                                    ...
                                                    success: function (data) {
                                                        // alert(data);
                                                        $(location).attr('href', 'vw_mapping.php');
                                                    }
                                                });
                                            });
                                        });
