...
WHERE A.id>1 AND G.flag_input='1' AND A.flag = '2' AND A.id_divisi='57'
...
LEFT JOIN ticket_staging.mr_ksldiv H
ON G.ID_KSLDIV = H.ID_KSLDIV
WHERE A.id>1 AND I.user_uid='$uiduser' AND I.flag='1' AND G.flag_input='1' AND A.flag = '2' AND A.id_divisi='57'
ORDER BY A.created_at DESC";
}
