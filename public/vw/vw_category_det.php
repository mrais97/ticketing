...
$sql = "SELECT 
        A.id AS 'ID Category Detail',
        A.detail_category_name AS 'Detail Category Name',
        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> Ticket Category Detail</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title" style="display: inline-block">Category Detail List</h4>
                                <button class="btn btn-rose" data-toggle="modal"
                                        data-target="#addtiket" style="float: right">Create Detail Category
                                ...
                                <div class="toolbar">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                            ...
                                            <thead>
                                            <tr>
                                                <th style="text-align: center;">ID Category Detail</th>
                                                <th style="text-align: center;">Category Detail Name</th>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center" class="td-actions">
                                                    <a class="btn btn-rose btn-fill" <?php echo "href='vw_edit_category_det.php?id=$row[0]'"; ?>>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title">Create Category Detail</h3>
                                    ...
                                    <form class="form-horizontal">
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-on-left">Category Detail Name</label>
                                                <div class="col-md-9">
                                                    <input class="form-control" type="text" id="catdetname"><!--</input>-->
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group row">
                                                ...
                                                <select id="cat">
                                                    ...
                                                    <?php
                                                    $sql = mysqli_query($con, "SELECT id,category_name FROM t_category where flag='1'");
                                        ...
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-md-3">Category Detail Status</label>
                                ...
                                <script>
                                    $(document).ready(function(){
                                        $("#button").click(function(){
                                            var catdetname=$("#catdetname").val();
                                            var cat=$("#cat").val();
                                            var flag=$("#flag").val();
                                            if(catdetname && cat && flag){
                                                $.ajax({
                                                    url:'../proses/pros_add_category_det.php',
                                                    method:'POST',
                                                    data:{
                                                    ...
                                                    success:function(data){
                                                        $(location).attr('href', 'vw_category_det.php');
                                                    }
                                                });
                                            }
                                            else{
