...
$sql = "SELECT * FROM t_category_detail WHERE id='$id' ";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title" style="display: inline-block">Edit Category Detail</h4>
                                <form class="form-horizontal" method="POST">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-sm-3" style="text-align: right;">Category Detail
                                                    ID</label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" type="text" id="catdetid"
                                        ...
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-md-3" style="text-align: right;">Category Detail
                                                    Name</label>
                                                <div class="col-md-6">
                                                    <input class="form-control" type="text" id="catdetname"
                                                           value="<?php echo $data['detail_category_name']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <select id="catid" class="col-md-3">
                                                            <?php
                                                            $sql = mysqli_query($con, "SELECT id,category_name FROM t_category");
                                                            while ($row = $sql->fetch_assoc()) {
                                                                $selected = ($row['id']== $data['id_category'] ? ' selected' : '' );
                                        ...
                                        <div class="row">
                                            <div class="form-group row">
                                                <label class="col-md-3" style="text-align: right;">Category Detail
                                                    Status</label>
                                                <div class="col-md-9">
                                                    <select data-style="select-with-transition" id="flag" class="col-md-3">
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            $("#button").click(function () {
                                                var catdetid = $("#catdetid").val();
                                                var catdetname = $("#catdetname").val();
                                                var catid = $("#catid").val();
                                                var flag = $("#flag").val();
                                                if(catdetid && catdetname && catid && flag) {
                                                $.ajax({
                                                    url: '../proses/pros_edit_category_det.php',
                                                    method: 'POST',
                                                    data: {
                                                        catdetid: catdetid,
